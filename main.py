...
Label(root,text ="Enter Text", font = 'arial 15 bold', bg = 'black', fg = 'white').place(x=20, y=140)
...
def Text_to_speech():
    Message = entry_field.get("1.0", "end")
    try:
...
def store():
    ...
    COUNTER += 1
    messagebox.showinfo("Audio stored", "Your audio is stored :)")
